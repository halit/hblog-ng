...
import { Copy, ShieldCheck, ShieldAlert, ShieldQuestion, Loader2 } from 'lucide-react';
...
export const SignatureModal: React.FC<SignatureModalProps> = ({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} label="PGP SIGNATURE" className="w-fit max-w-[95vw]">
        ...
        <div className="w-0 min-w-full space-y-4">
          <div className="text-sm text-gray-400 leading-relaxed space-y-2">
            ...
            <p className="text-xs text-gray-500">
              The signature covers the post content only, not metadata such as title, date, or other
              frontmatter fields.
            </p>
          </div>
